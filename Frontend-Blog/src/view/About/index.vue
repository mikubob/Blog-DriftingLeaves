        ...
        <div class="about-card">
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              <p>
                在文字的密林里迷路，在光影的缝隙中寻光。我是<strong>玄×</strong>，一名普通的计科学生，也是生活的记录者与梦想的追光人。
              </p>
              <p>
                这里存放着我的思考、热爱与偶尔的迷茫，愿与你一同探索世界的温柔与深邃。
              </p>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              <p>于我而言，这个博客更像是一方独属于自己的精神自留地。</p>
              <p>
                它诞生于一个朴素的心愿：想拥有一片专属的天地，来安放那些零散的思绪与成长的足迹，于是便有了这个小小的平台。
              </p>
              <p>
                过去也曾动过写日记的念头，却未曾真正付诸行动；后来虽写过一些零散的文字，但始终缺少一个真正属于自己的容器，来承载这些或深或浅的记录。于是，我亲手搭建了这个博客。
              </p>
              <p>
                我始终相信，当未来的某一天，我再次翻阅这些文字时，无论是为某个曾让我辗转反侧的技术难题，还是为生活中某件微不足道的小事所引发的感慨，这些记录都会让彼时的我与此刻的我悄然重逢，而后会心一笑。
              </p>
              <p>
                感谢你的到访。这里并无特别之处，不过是一个学生记录成长、思考与生活的小小角落。欢迎常来坐坐，愿这些文字能为你带来片刻的共鸣与温暖。
              </p>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="contact-list">
              <div class="contact-item">
                ...
                <span class="contact-value">2386782347</span>
              </div>
